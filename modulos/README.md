...
- `minijuego_2_pendiente`: espacio reservado para conectar el segundo minijuego.
- `minijuego_3_plataforma`: juego de plataforma con niveles y monedas.
- `minijuego_4_flappy`: Flappy Pescador.
...
- Minijuego 3 plataforma: `res://modulos/minijuego_3_plataforma/escenas/escena_principal/escena_principal.tscn`
- Minijuego 4 Flappy: `res://modulos/minijuego_4_flappy/escenas/minijuego_4_flappy/FlappyPescador.tscn`
