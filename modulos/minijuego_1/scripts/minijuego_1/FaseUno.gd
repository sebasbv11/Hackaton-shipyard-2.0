...
func _ejecutar_game_over() -> void:
	...
	print("Game Over ejecutado y transiciÃ³n iniciada.")
...
func _ir_a_fase_dos_mar() -> void:
	...
	var ruta = "res://modulos/minijuego_1/escenas/minijuego_1/fase_dos.tscn"
	if ResourceLoader.exists(ruta):
		get_tree().change_scene_to_file(ruta)
	else:
		get_tree().change_scene_to_file("res://modulos/minijuego_1/escenas/minijuego_1/fase_dos.tscn")
